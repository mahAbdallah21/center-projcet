    ...
    <div class="py-12">
        <div class="p-6 text-gray-900">
            <div class="flex justify-end p-5">
                <div>
                    <x-primary-link class="bg-blue-700 p=5 m=5" href="{{route('managers.create') }}">
                     {{__('massages.ADD NEW MANAGER')}}
                    </x-primary-link>
                </div>
            </div>
        ...
        <form  action="{{ route('managers.index') }}">
            ...
            <div class="flex">
              ...
              <input type="text" value="search for name  " name="search" class="w-full bg-black pl-2 text-base text-white font-semibold outline-0" placeholder="" id="" />
              <input type="submit" value="Search" class="bg-blue-800 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-400 transition-colors"/>
            </div>
</form>
                            ...
                            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                        <table class="min-w-full divide-y divide-gray-200 p-9 dark:divide-gray-700">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                                        <div class="inline-flex items-center gap-x-3">
                                                            ...
                                                            <span> {{$key + $managers->firstItem()}}</span>
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> {{ date_format(date_create($manager->created_at), 'Y-m-d h:i:s a') }}</td>
                                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                        <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-emerald-500 bg-emerald-100/60 dark:bg-gray-800">
                                                            ...
                                                            <h2 class="text-sm font-normal">{{$manager->mobile}}</h2>
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <div>
                                                                <h2 class="text-sm font-medium text-gray-800 dark:text-white "> {{$manager->name}} </h2>

                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{$manager->company->name}}</td>
