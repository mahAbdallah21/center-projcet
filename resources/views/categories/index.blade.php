    ...
    <div class="py-12">
        <div class="p-6 text-gray-900">
            <div class="flex justify-end p-5">
                <div>
                    <x-primary-link class="bg-blue-700 p=5 m=5" href="{{route('categories.create') }}">
                       {{__('massages.ADD NEW CATEGORY')}}
                        </x-primary-link>
                </div>
            </div>
        ...
        <form  action="{{ route('categories.index') }}">
            ...
            <div class="flex">
              ...
              <input type="text" value="{{__('massages.search for name Category ')}} " name="search" class="w-full bg-black pl-2 text-base text-white font-semibold outline-0" placeholder="" id="" />
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> {{ date_format(date_create($category->created_at), 'Y-m-d h:i:s a') }}</td>
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                        <div class="flex items-center gap-x-2">
                                                            <img class="object-cover w-8 h-8 rounded-full" src="{{$category->image}}" alt="">
                                                            <div>
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{$category->category_id ? $category->main_categorie->name : ''}}</td>
