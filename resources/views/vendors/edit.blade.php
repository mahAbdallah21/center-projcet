                ...
                <div class="p-6 text-gray-900">
                    <div class="  flex  items-center justify-center  bg-gray-50">
                        <div>
                          ...
                          <h1 class="mb-1 font-bold text-3xl flex gap-1 items-baseline font-mono">Edit<span class="text-sm text-purple-700">Vender</sm></h1>
                      <div class="grid max-w-3xl gap-2 py-10 px-8 sm:grid-cols-2 bg-white rounded-md border-t-4 border-purple-400">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{route('vendors.update',  $vendor->id)}}">
                            ...
                            <input type="text" name="name" value="{{old('name' , $vendor->name)}}" id="name" class="peer block w-full border-0 p-0 text-base text-gray-900 placeholder-gray-400 focus:ring-0" placeholder="name" />
                            @error('name')
                        ...
                        <div class="w-full">
                            ...
                            <img src="{{ asset('storage/' . $vendor->logo) }}" class="w-20 rounded">
                        </div>
                    @endif
