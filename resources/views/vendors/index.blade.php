    ...
    <div class="py-12">
        <div class="p-6 text-gray-900">
            <div class="flex justify-end p-5">
                <div>
                    <x-primary-link class="bg-blue-700 p=5 m=5" href="{{route('vendors.create') }}">
                    {{__('massages.ADD NEW VENDOR')}}
                    </x-primary-link>
                </div>
            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                                        <div class="inline-flex items-center gap-x-3">
                                                            ...
                                                            <span> {{$key + $vendors->firstItem()}}</span>
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <div>
                                                                <h2 class="text-sm font-medium text-gray-800 dark:text-white "> {{$vendor->name}} </h2>
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                      ...
                                                      @endif
                                                        ...
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> {{ date_format(date_create($vendor->created_at), 'Y-m-d h:i:s a') }}</td>
